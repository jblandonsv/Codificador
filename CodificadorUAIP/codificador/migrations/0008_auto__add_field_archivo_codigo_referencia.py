...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Archivo.codigo_referencia'
        db.add_column(u'codificador_archivo', 'codigo_referencia',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Archivo.codigo_referencia'
        db.delete_column(u'codificador_archivo', 'codigo_referencia')
