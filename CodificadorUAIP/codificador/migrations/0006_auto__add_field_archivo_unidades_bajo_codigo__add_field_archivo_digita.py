...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Archivo.unidades_bajo_codigo'
        db.add_column(u'codificador_archivo', 'unidades_bajo_codigo',
    ...
    def backwards(self, orm):
        # Deleting field 'Archivo.unidades_bajo_codigo'
        db.delete_column(u'codificador_archivo', 'unidades_bajo_codigo')
