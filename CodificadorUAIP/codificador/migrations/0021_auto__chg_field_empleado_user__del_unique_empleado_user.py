...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Empleado', fields ['user']
        db.delete_unique(u'codificador_empleado', ['user_id'])


        # Changing field 'Empleado.user'
        db.alter_column(u'codificador_empleado', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Empleado.user'
        db.alter_column(u'codificador_empleado', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Empleado', fields ['user']
        db.create_unique(u'codificador_empleado', ['user_id'])
