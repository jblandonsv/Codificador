...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArchivoHistorico.correlativo_sistema'
        db.delete_column(u'codificador_archivohistorico', 'correlativo_sistema')

        # Adding field 'ArchivoHistorico.reference_descriptivo'
        db.add_column(u'codificador_archivohistorico', 'reference_descriptivo',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ArchivoHistorico.fecha'
        db.add_column(u'codificador_archivohistorico', 'fecha',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 18, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ArchivoHistorico.correlativo_sistema'
        db.add_column(u'codificador_archivohistorico', 'correlativo_sistema',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=300),
                      keep_default=False)

        # Deleting field 'ArchivoHistorico.reference_descriptivo'
        db.delete_column(u'codificador_archivohistorico', 'reference_descriptivo')

        # Deleting field 'ArchivoHistorico.fecha'
        db.delete_column(u'codificador_archivohistorico', 'fecha')
