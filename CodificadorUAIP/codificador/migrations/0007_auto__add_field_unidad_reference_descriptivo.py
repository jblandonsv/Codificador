...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unidad.reference_descriptivo'
        db.add_column(u'codificador_unidad', 'reference_descriptivo',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unidad.reference_descriptivo'
        db.delete_column(u'codificador_unidad', 'reference_descriptivo')
