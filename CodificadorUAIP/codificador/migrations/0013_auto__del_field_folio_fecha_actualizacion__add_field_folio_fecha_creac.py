...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'folio.fecha_creacion'
        db.add_column(u'codificador_folio', 'fecha_creacion',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'folio.fecha_creacion'
        db.delete_column(u'codificador_folio', 'fecha_creacion')
