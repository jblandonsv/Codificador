...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TipoInformacion'
        db.create_table(u'codificador_tipoinformacion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True)),
        ))
        db.send_create_signal(u'codificador', ['TipoInformacion'])

        # Adding field 'folio.tipo_de_informacion'
        db.add_column(u'codificador_folio', 'tipo_de_informacion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['codificador.TipoInformacion'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TipoInformacion'
        db.delete_table(u'codificador_tipoinformacion')

        # Deleting field 'folio.tipo_de_informacion'
        db.delete_column(u'codificador_folio', 'tipo_de_informacion_id')
