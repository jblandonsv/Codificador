...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unidad.abreviatura'
        db.add_column(u'codificador_unidad', 'abreviatura',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unidad.abreviatura'
        db.delete_column(u'codificador_unidad', 'abreviatura')
