...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Archivo.correlativo_sistema'
        db.add_column(u'codificador_archivo', 'correlativo_sistema',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Archivo.correlativo_sistema'
        db.delete_column(u'codificador_archivo', 'correlativo_sistema')
