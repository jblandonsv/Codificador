...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Archivo.fecha_actualizacion'
        db.add_column(u'codificador_archivo', 'fecha_actualizacion',
                      self.gf('django.db.models.fields.DateField')(default=None, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Archivo.fecha_actualizacion'
        db.delete_column(u'codificador_archivo', 'fecha_actualizacion')
