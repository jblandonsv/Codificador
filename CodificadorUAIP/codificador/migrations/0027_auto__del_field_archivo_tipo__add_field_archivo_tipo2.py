...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Archivo.tipo'
        db.delete_column(u'codificador_archivo', 'tipo_id')

        # Adding field 'Archivo.tipo2'
        db.add_column(u'codificador_archivo', 'tipo2',
                      self.gf('smart_selects.db_fields.ChainedForeignKey')(default=None, to=orm['codificador.Tipo'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Archivo.tipo'
        db.add_column(u'codificador_archivo', 'tipo',
                      self.gf('smart_selects.db_fields.ChainedForeignKey')(default=None, to=orm['codificador.Tipo'], blank=True),
                      keep_default=False)

        # Deleting field 'Archivo.tipo2'
        db.delete_column(u'codificador_archivo', 'tipo2_id')
    ...
    models = {
        ...
        u'codificador.archivo': {
            ...
            'tipo2': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': u"orm['codificador.Tipo']", 'blank': 'True'}),
        ...
        u'codificador.archivohistorico': {
            ...
            'tipo': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
